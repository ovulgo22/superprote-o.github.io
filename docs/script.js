document.addEventListener('DOMContentLoaded', () => {
    ...
    const loadContent = async (page) => {
        ...
        try {
            ...
            // Pós-processamento do HTML renderizado em ordem de dependência
            enhanceCodeBlocks();
            createCodeTabs(); // NOVO: Deve rodar depois de enhanceCodeBlocks
            transformCallouts();
    ...
    // NOVO: Transforma grupos de blocos de código em abas interativas
        ...
        tabGroups.forEach((group, groupIndex) => {
            ...
            codeBlocks.forEach((block, blockIndex) => {
                ...
                button.addEventListener('click', () => {
                    ...
                    // Esconde todos os blocos e mostra o correto
                    codeBlocks.forEach((b, i) => {
                        b.classList.toggle('hidden', i !== blockIndex);
                    });
                });
